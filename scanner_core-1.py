...
WEIGHTS = {
    ...
    "profit_growth":   {"weight": 0.09, "direction": "high", "group_by_sector": False},
    "dividend_yield":  {"weight": 0.05, "direction": "high", "group_by_sector": False},
...
REGIME_WEIGHT_MULTIPLIERS = {
    ...
    "bearish": {"roe": 1.3, "debt_to_equity": 1.4, "dividend_yield": 1.6,
...
def extract_fundamental_metrics(info: dict) -> dict:
    ...
    return {
        ...
        "dividend_yield": dividend_yield * 100 if dividend_yield is not None else 0.0,
    }
